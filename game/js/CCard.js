function CCard(iX,iY,oParentContainer,szFotogram,iRank,iSuit,iUniqueID,iRot){
    ...
    this._init = function(iX,iY,oParentContainer,szFotogram,iRank,iSuit,iUniqueID,iRot){
        ...
        _oCardSprite = createSprite(oSpriteSheet,"back",
            UI_SIZES_AND_POSITIONS[currentUI].card_back().x,
            UI_SIZES_AND_POSITIONS[currentUI].card_back().y,
            UI_SIZES_AND_POSITIONS[currentUI].card_back().width,
            UI_SIZES_AND_POSITIONS[currentUI].card_back().height
        );
        _oCardSprite.scaleX = UI_SIZES_AND_POSITIONS[currentUI].card_back().scale
        _oCardSprite.scaleY = UI_SIZES_AND_POSITIONS[currentUI].card_back().scale
        _oCardSprite.stop();
    ...
    this._mouseDown = function(event){
        ...
        s_oGame.playCard.call(s_oGame,_oParent,event);
    };
