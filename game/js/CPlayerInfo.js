function CPlayerInfo(iX, iY, oParentContainer, szName){
    ...
    this._init = function(iX, iY, oParentContainer, szName){
        ...
        _iWidth = UI_SIZES_AND_POSITIONS[currentUI].oPlayerLine(oSprite).width;
        _iHeight = UI_SIZES_AND_POSITIONS[currentUI].oPlayerLine(oSprite).height;
        var oData = {
            images: [oSprite],
        ...
        _oLinePlayer.scaleX = UI_SIZES_AND_POSITIONS[currentUI].oPlayerLine(oSprite).scale
        _oLinePlayer.scaleY = UI_SIZES_AND_POSITIONS[currentUI].oPlayerLine(oSprite).scale
        _oLinePlayer.stop();
        ...
        _oPlayerText = new CTLText(_oTextContainer, 
                    ...
                    UI_SIZES_AND_POSITIONS[currentUI].player_text().font_size, 
                    "left", "#fff", PRIMARY_FONT, 1,
                    0, 0,
                    _szName,
                    true, true, false,
                    false );
    ...
    this._setNormalDir = function(){
        ...
        _oPlayerText.setPos(UI_SIZES_AND_POSITIONS[currentUI].player_text(_iWidth, _iOffsetX).x, -_iTextHeight);
    ...
    this._setInverseDir = function(){
        ...
        _oPlayerText.setPos(UI_SIZES_AND_POSITIONS[currentUI].player_text(_iWidth, _iOffsetX).n_x, 4);
