function CInfoLabel(iX, iY, oParentContainer){
    ...
    this.pulseAnimation = function () {
        createjs.Tween.get(_oContainer, {loop: true}).to({scaleX: currentUI ==="MOBILE_DEVICE" ? 0.5 : 0.9, scaleY: currentUI ==="MOBILE_DEVICE" ? 0.5 : 0.9}, 850, createjs.Ease.quadOut).to({scaleX: currentUI ==="MOBILE_DEVICE" ? 0.5 : 1, scaleY: currentUI ==="MOBILE_DEVICE" ? 0.5 : 1}, 650, createjs.Ease.quadIn);
    };
