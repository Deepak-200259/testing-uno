function CAnimation (){
    ...
    this.drawFourAnim = function (iIndexPlayer,iNumberOfCards,iDelay,iDrawType){
        _oDrawFour.alpha = 0;
        ...
        new createjs.Tween.get(_oDrawFour).to({alpha: 1, 
            scaleX: _scaleUp, 
            scaleY: _scaleUp
        ...
        }).wait(200).to({alpha: 0, scaleX: 0.01, scaleY: 0.01},200, createjs.Ease.cubicIn).call(function(){ 
            s_oStage.removeChild(_oDrawFour); 

            s_oGame.drawCardsTween(iIndexPlayer,iNumberOfCards,iDelay,iDrawType);
        });
    };
    
    this.drawTwoAnim = function (iIndexPlayer,iNumberOfCards,iDelay,iDrawType){
        _oDrawTwo.alpha = 0;
        ...
        new createjs.Tween.get(_oDrawTwo).to({alpha: 1, 
            scaleX: _scaleUp, 
            scaleY: _scaleUp
        },200, createjs.Ease.cubicOut).wait(200).call(function(){
    ...
    this.stopTurn = function (){
        return  new Promise(function(resolve, reject){
            ...
            new createjs.Tween.get(_oStopTurn).to({alpha: 1, scaleX: _scaleUp, scaleY: _scaleUp},200, createjs.Ease.cubicOut)
                    .to({scaleX: _scaleDown, scaleY: _scaleDown},200)
                    .to({scaleX: _scaleUp, scaleY: _scaleUp},200)
                    .to({scaleX: _scaleDown, scaleY: _scaleDown},200)
                    .to({scaleX: _scaleUp, scaleY: _scaleUp},200)
                    .to({alpha: 0, scaleX: 0.01, scaleY: 0.01},200, createjs.Ease.cubicIn).call(function(){
    ...
    this.changeClockWise = function(bClockWise){
        ...
        return  new Promise(function(resolve, reject){
            ...
            if (bClockWise===false){
                new createjs.Tween.get(_oChangeClockWise).to({alpha: 1, 
                    scaleX: _scaleUp, 
                    scaleY: _scaleUp
                },200, createjs.Ease.cubicOut)
                        .to({rotation: 360},500).wait(500)
                        .to({rotation: -360},500).wait(500)
                        .to({alpha: 0, scaleX: 0.01, scaleY: 0.01},200, createjs.Ease.cubicIn).call(function(){ 
    ...
    this.changeColor = function(iColor){
        ...
        return  new Promise(function(resolve, reject){
            ...
            new createjs.Tween.get(_oChangeColor).to({alpha: 1, 
                scaleX: _scaleUp, 
                scaleY: _scaleUp
                ...
                _bColor = true;
                _oChangeColor.on("animationend",s_oCAnimation.endAnimation, s_oCAnimation, false, resolve);
    ...
    this.endAnimation = function(evt, resolve){
        if (_bColor === true){
            ...
            _oChangeColor.removeAllEventListeners();
            _oChangeColor.stop(); 
            ...
            new createjs.Tween.get(_oChangeColor).to({
                ...
                scaleX: _scaleDown, 
                scaleY: _scaleDown
            },250).to({alpha: 0, scaleX: 0.1, scaleY: 0.1},200, createjs.Ease.cubicIn)
                .call(function(){ 
    ...
    this.shuffleAnimation = function(){
        return  new Promise(function(resolve, reject){
            ...
            _oShuffleAnim.stop();
            new createjs.Tween.get(_oShuffleAnim).to({alpha: 1, 
                scaleX: _scaleUp, 
                scaleY: _scaleUp
                    ...
                    _oCardShufflingSound = playSound("card_dealing", 1,true);
                        ...
                        stopSound("change_color");
                    }).to({alpha: 0, scaleX: 0.01, scaleY: 0.01},300, createjs.Ease.cubicIn).call(function(){
