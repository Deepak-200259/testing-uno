function CMain(oData){
    ...
    this._loadImages = function(){
        ...
        s_oSpriteLibrary.addSprite("but_swap_color","./sprites/btn_swap_color.png");
        ...
        if(currentUI === "MOBILE_DEVICE"){
            s_oSpriteLibrary.addSprite("bg_center_box","./sprites/bg_center_box.png"); 
            s_oSpriteLibrary.addSprite("bg_mask","./sprites/bg_mask.png"); 
            s_oSpriteLibrary.addSprite("start_bg_logo","./sprites/ipad_menu_logo.png"); 
            s_oSpriteLibrary.addSprite("bg_logo","./sprites/bg_logo.png"); 
            s_oSpriteLibrary.addSprite("bg_menu","./sprites/ipad_bg.png");
            s_oSpriteLibrary.addSprite("bg_game","./sprites/ipad_bg.png");
        } else if (currentUI === "DESKTOP_DEVICE"){
            s_oSpriteLibrary.addSprite("bg_game","./sprites/bg_game.jpg");
            s_oSpriteLibrary.addSprite("bg_menu","./sprites/bg_menu.jpg");
        } else if(currentUI === "IPAD_DEVICE") {
            s_oSpriteLibrary.addSprite("start_bg_logo","./sprites/ipad_menu_logo.png");
            s_oSpriteLibrary.addSprite("bg_menu","./sprites/ipad_bg_rotate.png");
            s_oSpriteLibrary.addSprite("bg_logo","./sprites/bg_logo.png");
            s_oSpriteLibrary.addSprite("bg_center_box","./sprites/bg_center_box.png");
            s_oSpriteLibrary.addSprite("bg_game","./sprites/ipad_bg_rotate.png");
        } else if(currentUI === "IPAD_DEVICE_3X4"){
            s_oSpriteLibrary.addSprite("start_bg_logo","./sprites/ipad_menu_logo.png");
            s_oSpriteLibrary.addSprite("bg_menu","./sprites/ipad_bg.png");
            s_oSpriteLibrary.addSprite("bg_logo","./sprites/ipad_bg_logo.png");
            s_oSpriteLibrary.addSprite("bg_center_box","./sprites/ipad_bg_center_box.png");
            s_oSpriteLibrary.addSprite("bg_game","./sprites/ipad_bg.png");
        }
